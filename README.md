...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/slice-base@v0.2.2-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { args2multislice, int2slice, nonreducedDimensions, normalizeMultiSlice, normalizeSlice, reducedDimensions, sargs2multislice, seq2multislice, seq2slice, slice2seq, sliceLength, sliceShape, str2multislice, str2slice } from 'https://cdn.jsdelivr.net/gh/stdlib-js/slice-base@v0.2.2-deno/mod.js';
```
